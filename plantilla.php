...
?>
			...
			<center><h4><?php echo $programa["nombre_programa"];	?></h4></center>
			<ul class="s_nav">
		...
		<div class="details">
					<div id="container_7_7">	
						<div class="container_7_7_head"><?php echo $programa["nombre_programa"];	?></div>
					</div>


					<div id="container_8_8">	
						<div class="container_8_8_head"> Misión</div>
	
						<div class="container_8_8_label"><p align="justify"><?php echo $programa["mision"];	?></p></div>
					</div>
					<div id="container_8_8">	
						<div class="container_8_8_head"> Visión</div>
	
						<div class="container_8_8_label"><p align="justify"><?php echo $programa["perfil_egresado"];	?></p></div>
					</div><div id="container_8_8">	
						<div class="container_8_8_head"> Perfil del Egresado</div>
