...
<ul class="menu">
   ...
   <li class='active has-sub'><a href='#' class="first-sub"><span>Institución</span></a>
      ...
      <ul>
         <li class='has-sub-2'><a href='#' class=""><span>Tecnologia - Recursos Naturales</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Agroalimentación</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Enfermería</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Procesamiento y Distribuvión de Alimentos</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Procesos Químicos</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Informatíca</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Administración</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Higiene y Seguridad Laboral</span></a>
         <li class='has-sub-2'><a href='#' class=""><span>PNF - Fonología</span></a>
   ...
   <li class='last'><a href='contact.html'><span>Contáctanos</span></a></li>
		...
		<div class="sidebar2">
			...
			<center><h4>Nombre Programa</h4></center>
			<ul class="s_nav">
				<li><center><img src="web/images/service.png"></center></li>
				<li><center><p class="para">
	<?php
      	include('php/bd.php');
		conectar();

		$programa=$_GET['id'];
		$SQL="SELECT * FROM programa where id_programa=$programa";
		$ejecucion=mysql_query($SQL);

		while($programa=mysql_fetch_array($ejecucion)){
			echo $programa["nombre_programa"];
}
...
<!----start-images-slider---->
		...
		<div id="container_5_5">	
		<div class="container_5_5_head">Imagenes del Programa</div>
		
			</div>
<!--start main -->

					<div id="container_6_6">	
						<div class="container_6_6_head"> Perfil del Egresado</div>
	
						<div class="container_6_6_label"><center><?php echo $programa["perfil_egresado"];	}?></center></div>
